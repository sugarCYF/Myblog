...
class Admin extends Rbac
{
    public function adminlist(){
        ...
        return view('adminlist',['adminlist'=>$adminlist,'keywords'=>$keywords,'page'=>$page,'count'=>$count[0]['count'],'p'=>$p]);
    }
    ...
    public function adminadd(){
        if($_POST){
            ...
            return view('adminadd',['rolelist'=>$rolelist]);
        }
    }
    ...
    public function roleadd(){
        if($_POST){
            ...
            return view('roleadd',['nodelist'=>$nodelist]);
        }
    }
    public function changerole(){
        ...
        if($_POST){
            ...
            $rolelist=db('admin_role')->select();
            return view('changerole',['adminlist'=>$array,'rolelist'=>$rolelist]);
        }
    }
    public function rolelist(){
        ...
        return view('rolelist',['rolelist'=>$rolelist,'keywords'=>$keywords,'page'=>$page,'count'=>$count[0]['count'],'p'=>$p]);
    }
    public function changenode(){
        ...
        if($_POST){
            ...
            $nodelist=db('admin_node')->select();
            return view('changenode',['rolelist'=>$array,'nodelist'=>$nodelist]);
        }
    }
